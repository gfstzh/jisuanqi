...
public class MainActivity2 extends Activity
{
    ...
    private OnClickListener actionPerformed = new OnClickListener() {
        public void onClick(View v) {
            ...
            //检测输入是否合法
            if(equals_flag == false && "0123456789.()sincostanasinacosatansinhcoshtanhasinhacoshatanhlnlogn!+-×÷√^".indexOf(command) != -1) {
                //检测显示器上的字符串是否合法
                if(right(str)) {
            ...
            if("0123456789.()sincostanasinacosatansinhcoshtanhasinhacoshatanhlnlogn!+-×÷√^".indexOf(command) != -1 && tip_lock) {
                Tipcommand[tip_i] = command;
                tip_i++;
            }
            //若输入正确，则将输入信息显示到显示器上
            if("0123456789.()sincostanasinacosatansinhcoshtanhasinhacoshatanhlnlogn!+-×÷√^".indexOf(command) != -1
                    && tip_lock) { //共25个按键
                print(command);
                ...
                if(TTO(str) == 5){
                    if(str.length()>5)
                        input.setText(str.substring(0,str.length() - 5));
                ...
                //一次删除4个字符
                    ...
                    if(str.length()>4)
                        input.setText(str.substring(0,str.length() - 4));
                ...
                if(input.getText().toString().compareTo("-") == 0 || !equals_flag) {
                    input.setText("0");
                    vbegin = true;
                    tip_i = 0;
                    tip.setText("欢迎使用！");
                ...
                str_old = str;
                /*
                新增asinh,acosh,atanh 使用 o,p,q
                 */
                str = str.replaceAll("asinh", "o");
                str = str.replaceAll("acosh", "p");
                str = str.replaceAll("atanh", "q");
                /*
                新增 asin,acos,atan,sinh,cosh,tanh,"sctgl已用"
                 */
                str = str.replaceAll("asin", "h");
                str = str.replaceAll("acos", "i");
                str = str.replaceAll("atan" , "j");
                str = str.replaceAll("sinh", "k");
                str = str.replaceAll("cosh", "m");
                str = str.replaceAll("tanh", "n");
                //替换算式中的运算符，便于计算
     ...
     * 只包含"0123456789.()sincostanasinacosatansinhcoshtanhasinhacoshatanhlnlogn!+-×÷√^"的是合法的str，返回true
     * 包含了除"0123456789.()sincostanasinacosatansinhcoshtanhasinhacoshatanhlnlogn!+-×÷√^"以外的字符的str为非法的，返回false
     */
    private boolean right(String str) {
        ...
        for(i = 0;i < str.length();i++) {
            if(str.charAt(i)!='0' && str.charAt(i)!='1' && str.charAt(i)!='2' &&
                    ...
                    str.charAt(i)!=')' && str.charAt(i)!='!' && str.charAt(i)!='h')   // 后面加的h
                break;
        }
        return i == str.length();
    }
    /*
     * 检测函数，返回值为5,4，3、2、1  表示应当一次删除几个？
     * 为Bksp按钮的删除方式提供依据
     * 返回5，表示str尾部为asinh,acosh,atanh中的一个，应当一次删除5个
     * 返回4，表示str尾部为asin,acos,atan,sinh,cosh,tanh中的一个，应当一次删除4个
     * 返回3，表示str尾部为sin、cos、tan、log,中的一个，应当一次删除3个
    ...
    private int TTO(String str) {
        if((str.charAt(str.length() - 1) == 'h' &&
                ...
                str.charAt(str.length() - 3) == 'i' &&
                str.charAt(str.length() - 4) == 's' &&
                str.charAt(str.length() - 5) == 'a')//asinh
                ||
                (str.charAt(str.length() - 1) == 'h' &&
                        str.charAt(str.length() - 2) == 's' &&
                        str.charAt(str.length() - 3) == 'o' &&
                        str.charAt(str.length() - 4) == 'c' &&
                        str.charAt(str.length() - 5) == 'a')//acosh
                ||
                (str.charAt(str.length() - 1) == 'h' &&
                        str.charAt(str.length() - 2) == 'n' &&
                        str.charAt(str.length() - 3) == 'a' &&
                        str.charAt(str.length() - 4) == 't' &&
                        str.charAt(str.length() - 5) == 'a')) //atanh
        {return 5;}
        else if((str.charAt(str.length() - 1) == 'n' &&
                str.charAt(str.length() - 2) == 'i' &&
                str.charAt(str.length() - 3) == 's' &&
                str.charAt(str.length() - 4) == 'a')//asin
                ||
                (str.charAt(str.length() - 1) == 's' &&
                        str.charAt(str.length() - 2) == 'o' &&
                        str.charAt(str.length() - 3) == 'c' &&
                        str.charAt(str.length() - 4) == 'a')//acos
                ||
                (str.charAt(str.length() - 1) == 'n' &&
                        str.charAt(str.length() - 2) == 'a' &&
                        str.charAt(str.length() - 3) == 't' &&
                        str.charAt(str.length() - 4) == 'a')//atan
                ||
                (str.charAt(str.length() - 1) == 'h' &&
                        str.charAt(str.length() - 2) == 'n' &&
                        str.charAt(str.length() - 3) == 'i' &&
                        str.charAt(str.length() - 4) == 's')//sinh
                ||
                (str.charAt(str.length() - 1) == 'h' &&
                        str.charAt(str.length() - 2) == 's' &&
                        str.charAt(str.length() - 3) == 'o' &&
                        str.charAt(str.length() - 4) == 'c')//cosh
                ||
                (str.charAt(str.length() - 1) == 'h' &&
                        str.charAt(str.length() - 2) == 'n' &&
                        str.charAt(str.length() - 3) == 'a' &&
                        str.charAt(str.length() - 4) == 't')) //tanh
        {return 4;}

        else if((str.charAt(str.length() - 1) == 'n' &&
                str.charAt(str.length() - 2) == 'i' &&
                str.charAt(str.length() - 3) == 's') //sin
                ||
                (str.charAt(str.length() - 1) == 's' &&
                        str.charAt(str.length() - 2) == 'o' &&
                        str.charAt(str.length() - 3) == 'c')
    ...
    private void TipChecker(String tipcommand1,String tipcommand2) {
        ...
        //定义存储字符串中最后一位的类型
            ...
            if(tipcommand1.compareTo("(") == 0) {
                ...
                tiptype1 = 6;
            } else if("sincostanasinacosatansinhcoshtanhasinhacoshatanhlnlogn!".contains(tipcommand1)) {
                tiptype1 = 7;
            }
            //定义欲输入的按键类型
            if(tipcommand2.compareTo("(") == 0) {
                ...
                tiptype2 = 6;
            } else if("sincostanasinacosatansinhcoshtanhasinhacoshatanhlnlogn!".contains(tipcommand2)) {
                tiptype2 = 7;
            }
        ...
        if(Tipcode1 == 0 && tipcommand2.compareTo(".") == 0) {
            ...
            for(int i = 0;i < tip_i;i++) {
                ...
                if(Tipcommand[i].compareTo("sin") == 0 || Tipcommand[i].compareTo("cos") == 0 ||
                        Tipcommand[i].compareTo("asin") == 0 || Tipcommand[i].compareTo("acos") == 0 ||
                        Tipcommand[i].compareTo("atan") == 0 || Tipcommand[i].compareTo("sinh") == 0 ||
                        Tipcommand[i].compareTo("cosh") == 0 || Tipcommand[i].compareTo("tanh") == 0 ||
                        Tipcommand[i].compareTo("asinh") == 0 || Tipcommand[i].compareTo("acosh") == 0 ||
                        Tipcommand[i].compareTo("atanh") == 0 ||
        ...
        if(Tipcode1 == 0 && tipcommand2.compareTo("=") == 0) {
            ...
            if(tip_bracket > 0) {
                ...
                //若前一个字符是以下之一，表明=号不合法
                if("sincostanasinacosatansinhcoshtanhasinhacoshatanhlnlogn!".contains(tipcommand1)) {
                    Tipcode1 = 6;
                }
                //若前一个字符是以下之一，表明=号不合法
