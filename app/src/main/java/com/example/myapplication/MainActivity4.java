...
public class MainActivity4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //建立数据源
        String[] mltems = getResources().getStringArray(R.array.lala);
        String[] mltems2 = getResources().getStringArray(R.array.lala2);
        String[] mltems3 = getResources().getStringArray(R.array.lala3);
        ...
        spinner1.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int pos, long id) {
                switch (pos){
                    case 0: spinner2.setAdapter(adapter2);
                    ...
                    break;
                    case 1: spinner2.setAdapter(adapter3);
                        spinner2.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                            @Override
                            public void onItemSelected(AdapterView<?> parent, View view, final int pos, long id) {
                                switch (pos){
